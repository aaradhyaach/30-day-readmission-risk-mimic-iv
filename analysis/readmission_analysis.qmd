...
This analysis demonstrates that administrative and utilization-based EHR variables are
meaningfully associated with 30-day readmission risk. Prior utilization, diagnosis
category, and comorbidity burden emerged as the strongest predictors, with
Mental/Behavioral and Neoplasm diagnoses warranting particular attention in discharge
planning and post-acute follow-up programs. The baseline model achieved an AUC of
0.637 using only administrative features available at discharge in any EHR — a
foundation that future work should extend by incorporating clinical variables such as
laboratory values, vital signs, and validated comorbidity indices to further improve
discrimination.